...
const createNavbar = () => {
    ...
    navbar.innerHTML += `
        ...
        <li class="link-item"><a href="#" class="link active" onclick="location.href = '/'">home</a></li>
            <li class="link-item"><a href="#" class="link" onclick="location.href = '/dashboard'" >product</a></li>
            <li class="link-item"><a href="#" class="link" onclick="location.href = '/abouts'">about</a></li>
